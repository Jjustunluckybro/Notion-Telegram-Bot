...
from src.services.ui.inline_keyboards import create_save_kb, create_change_theme_kb, create_theme_menu_kb
...
async def change_theme_accept(
    ...
    kb = create_save_kb()
    kb.attach(create_change_theme_kb())
...
@router.callback_query(
    ...
    ChangeTheme.change_theme or ChangeTheme.change_description)
@handel_storage_unexpected_response
@async_method_arguments_logger(logger)
async def change_theme_accept(
        callback: types.CallbackQuery,
